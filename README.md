...
Donate link: 
Tags: BigCommerce to woocommerce, BigCommerce to woocommerce migration, migrate BigCommerce to woocommerce  
...
This plugin allows you to migrate your products, orders, customers, passwords and other data from BigCommerce to WooCommerce automatically.

== Description ==
This plugin allows you to migrate your products, categories, orders, customers, passwords and other data from BigCommerce to WooCommerce automatically. 
...
 
= ADDITIONAL FEATURES =
* No Downtime: Data is migrated with no downtime for your current BigCommerce store
...
* Migrate Recent Data: You have just finished a full migration, after that BigCommerce is still live and continue getting new data, and you want to get your WooCommerce updated with the new data, this feature to avoid starting over again.
...
* Data Security: Direct data transfer from BigCommerce to WooCommerce, NO third party involved
...
3. Go to the Plugins -> BigCommerce to WooCommerce Migration


== Documentation and Support ==
Please visit [LitExtension FAQ section](http://litextension.com/woocommerce-migration-tool/BigCommerce-to-woocommerce.html) if you have any questions about migration to WooCommerce.
